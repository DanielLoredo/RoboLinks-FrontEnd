...
import { uploadImageCloudinary } from "../../scripts/imageScript";
...
export default function CreateLinkForm({ created_link_data }) {
  ...
  const submitForms = () => {
    ...
    // TODO: IF image_selected == "", then call a function to assign a default image
    // Check the issue to see the default images corresponding to each tag :)
    // Call setImageSelected() with the default Image :)
    ...
    uploadImageCloudinary(image_selected);
  };
